...
- install all packages from ```requirements.txt``` by using a terminal and runing this command ```pip install -r requirements.txt.```
- open a terminal in your IDE and run ```python getAbstract.py``` or any of the other files.
