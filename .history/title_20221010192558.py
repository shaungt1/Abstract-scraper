...
class PubMedSpider(Spider):
    name = 'pubmedScraper'
    start_urls = [
        'view-source:https://pubmed.ncbi.nlm.nih.gov/?term=electronic+nose+%28e-nose%29%2C+machine+learning+detection&format=abstract&size=100',
    ]
    ...
    def parse(self,response):
        ...
        for q in response.xpath('//div[2]/article/div/div/p'):
            yield {
