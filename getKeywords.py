...
TITLE = 'Keywords_' # enter a title for your job
...
class PubMedSpider(Spider):
    ...
    custom_settings = {
            'FEED_FORMAT': 'csv',
            'FEED_URI': TITLE + '_' + '_data.csv', #'Rename current working data set',
            }

    def parse(self,response):
        for q in response.xpath('//article/div[1]/p'):
            yield {
                'Keywords': q.xpath('text()').get(),
            }
